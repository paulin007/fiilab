...
public class MainTest2 {
	...
	public static void main(String[] args) {
		...
		preparaVisualizzatore(mediator, panel1, new VisualizzazionePanel(
				DatiTest.personaggi()));
		preparaVisualizzatore(mediator, panel1, new VisualizzazionePanel("AquilaReale"));
		preparaVisualizzatore(mediator, panel1, new VisualizzazionePanel("Coccodrillo"));
		preparaVisualizzatore(mediator, panel1, new VisualizzazionePanel("OrangoTango"));
